...
enum KazePreviewData {
    static func make(window: TelemetryWindow) -> (
        ...
        do {
            ...
            let sensors = [
                try SensorDescriptor(key: "TCDX", family: .cpu, safetyLimitCelsius: 100),
                try SensorDescriptor(key: "TCHP", family: .cpu, safetyLimitCelsius: 100),
                try SensorDescriptor(key: "TCMb", family: .cpu, safetyLimitCelsius: 100),
                try SensorDescriptor(key: "Tp01", family: .cpu, safetyLimitCelsius: 100),
                try SensorDescriptor(key: "Tp02", family: .cpu, safetyLimitCelsius: 100),
                try SensorDescriptor(key: "Tp03", family: .cpu, safetyLimitCelsius: 100),
                try SensorDescriptor(key: "Tp04", family: .cpu, safetyLimitCelsius: 100),
                try SensorDescriptor(key: "Tp05", family: .cpu, safetyLimitCelsius: 100),
                try SensorDescriptor(key: "Tp06", family: .cpu, safetyLimitCelsius: 100),
                try SensorDescriptor(key: "Tp07", family: .cpu, safetyLimitCelsius: 100),
                try SensorDescriptor(key: "Tp08", family: .cpu, safetyLimitCelsius: 100),
                try SensorDescriptor(key: "Tp09", family: .cpu, safetyLimitCelsius: 100),
                try SensorDescriptor(key: "Tp0A", family: .cpu, safetyLimitCelsius: 100),
                try SensorDescriptor(key: "Tg05", family: .gpu, safetyLimitCelsius: 100),
                try SensorDescriptor(key: "Tg0D", family: .gpu, safetyLimitCelsius: 100),
                try SensorDescriptor(key: "Tg0L", family: .gpu, safetyLimitCelsius: 100),
                try SensorDescriptor(key: "Tg0T", family: .gpu, safetyLimitCelsius: 100),
                try SensorDescriptor(key: "Tg0f", family: .gpu, safetyLimitCelsius: 100),
                try SensorDescriptor(key: "Tg0j", family: .gpu, safetyLimitCelsius: 100),
